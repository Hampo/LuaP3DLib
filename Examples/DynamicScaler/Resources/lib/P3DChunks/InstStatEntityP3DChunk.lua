...
assert(P3D.InstStatEntityP3DChunk == nil, "Chunk type already loaded.")
...
P3D.InstStatEntityP3DChunk = P3D.P3DChunk:newChildClass(P3D.Identifiers.Inst_Stat_Entity)
P3D.InstStatEntityP3DChunk.new = new
function P3D.InstStatEntityP3DChunk:parse(Contents, Pos, DataLength)
...
function P3D.InstStatEntityP3DChunk:__tostring()
	local chunks = {}
