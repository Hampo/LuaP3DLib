...
assert(P3D.StatePropVisibilitiesDataP3DChunk == nil, "Chunk type already loaded.")
...
P3D.StatePropVisibilitiesDataP3DChunk = P3D.P3DChunk:newChildClass(P3D.Identifiers.State_Prop_Visibilities_Data)
