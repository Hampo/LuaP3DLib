...
assert(P3D.OldScenegraphVisibilityP3DChunk == nil, "Chunk type already loaded.")
...
P3D.OldScenegraphVisibilityP3DChunk = P3D.P3DChunk:newChildClass(P3D.Identifiers.Old_Scenegraph_Visibility)
