...
function MakeModelSolid(Original)
	...
	for idx in RootChunk:GetChunkIndexes(P3D.Identifiers.Anim_Dyna_Phys) do
		...
		if AnimDynaPhysChunk.Name ~= "l1z6_powerbox_Shape\0" and (Settings.SolidCrates or not (AnimDynaPhysChunk.Name:match("crate") or AnimDynaPhysChunk.Name:match("vending"))) then
