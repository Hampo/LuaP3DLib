...
P3D.Identifiers = {
	...
	Expression = 0x21000, -- Done
	Expression_Group = 0x21001, -- Done
	Expression_Mixer = 0x21002, -- Done
	Fence = 0x3F00007, -- Done
	Fence_2 = 0x3000000, -- Done
	Float_1_Channel = 0x121100, -- Done
	Float_2_Channel = 0x121101, -- Done
	Follow_Camera_Data = 0x3000100, -- Done
	Frame_Controller = 0x121201, -- TODO
	Frontend_Group = 0x18004, -- Done
	Frontend_Image_Resource = 0x18100, -- Done
	Frontend_Language = 0x1800E, -- Done
	Frontend_Layer = 0x18003, -- Done
	Frontend_Multi_Sprite = 0x18006, -- Done
	Frontend_Multi_Text = 0x18007, -- Done
	Frontend_Page = 0x18002, -- Done
	Frontend_Polygon = 0x18009, -- Done
	Frontend_Project = 0x18000, -- Done
	Frontend_Pure3D_Object = 0x18008, -- Done
	Frontend_Pure3D_Resource = 0x18101, -- Done
	Frontend_Screen = 0x18001, -- Done
	Frontend_String_Hard_Coded = 0x1800C, -- Done
	Frontend_String_Text_Bible = 0x1800B, -- Done
	Frontend_Text_Bible = 0x1800D, -- Done
	Frontend_Text_Bible_Resource = 0x18105, -- Done
	Frontend_Text_Style_Resource = 0x18104, -- Done
	Game_Attr = 0x12000, -- Done
	Game_Attribute_Integer_Parameter = 0x12001, -- Done
	Game_Attribute_Float_Parameter = 0x12002, -- Done
	Game_Attribute_Colour_Parameter = 0x12003, -- Done
	Game_Attribute_Vector_Parameter = 0x12004, -- Done
	Game_Attribute_Matrix_Parameter = 0x12005, -- Done
	Grid = 0x1000, -- Done
