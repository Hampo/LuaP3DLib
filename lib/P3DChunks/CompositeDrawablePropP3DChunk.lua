...
P3D.CompositeDrawablePropP3DChunk = setmetatable(P3D.P3DChunk:newChildClass(P3D.Identifiers.Composite_Drawable_Prop), {__call = new})
...
function P3D.CompositeDrawablePropP3DChunk:__tostring()
	local chunks = {}
