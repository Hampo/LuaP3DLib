...
function P3D.CollisionObjectP3DChunk:__tostring()
	...
	return string_pack("<IIIs1Is1II", self.Identifier, headerLen, headerLen + #chunkData, Name, self.Version, MaterialName, self.NumSubObject, self:GetNumOwners()) .. chunkData
end