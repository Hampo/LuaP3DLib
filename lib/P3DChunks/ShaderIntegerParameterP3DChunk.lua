...
function P3D.ShaderIntegerParameterP3DChunk:parse(Endian, Contents, Pos, DataLength)
	local chunk = self.parentClass.parse(self, Endian, Contents, Pos, DataLength, self.Identifier)
	
	chunk.Param, chunk.Value = string_unpack(Endian .. "c4I", chunk.ValueStr)
	if Endian == ">" then
...
function P3D.ShaderIntegerParameterP3DChunk:__tostring()
	...
	return string_pack(self.Endian .. "IIIc4I", self.Identifier, headerLen, headerLen + #chunkData, self.Param, self.Value) .. chunkData
end