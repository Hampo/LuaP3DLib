...
P3D.Road2P3DChunk = setmetatable(P3D.P3DChunk:newChildClass(P3D.Identifiers.Road_2), {__call = new})
P3D.Road2P3DChunk.new = new
...
function P3D.Road2P3DChunk:__tostring()
	local chunks = {}
