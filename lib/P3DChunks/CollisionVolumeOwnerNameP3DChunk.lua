...
P3D.CollisionVolumeOwnerNameP3DChunk = setmetatable(P3D.P3DChunk:newChildClass(P3D.Identifiers.Collision_Volume_Owner_Name), {__call = new})
P3D.CollisionVolumeOwnerNameP3DChunk.new = new
function P3D.CollisionVolumeOwnerNameP3DChunk:parse(Contents, Pos, DataLength)
