...
assert(P3D.AnimCollP3DChunk == nil, "Chunk type already loaded.")
...
P3D.AnimCollP3DChunk = P3D.P3DChunk:newChildClass(P3D.Identifiers.Anim_Coll)
P3D.AnimCollP3DChunk.new = new
function P3D.AnimCollP3DChunk:parse(Contents, Pos, DataLength)
...
function P3D.AnimCollP3DChunk:__tostring()
	local chunks = {}
