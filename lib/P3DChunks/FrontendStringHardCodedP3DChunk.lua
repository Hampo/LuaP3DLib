...
P3D.FrontendStringHardCodedP3DChunk = setmetatable(P3D.P3DChunk:newChildClass(P3D.Identifiers.Frontend_String_Hard_Coded), {__call = new})
...
function P3D.FrontendStringHardCodedP3DChunk:__tostring()
	...
	return string_pack("<IIIs1", self.Identifier, headerLen, headerLen + #chunkData, String) .. chunkData
end