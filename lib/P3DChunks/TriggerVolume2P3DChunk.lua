...
P3D.TriggerVolume2P3DChunk = setmetatable(P3D.P3DChunk:newChildClass(P3D.Identifiers.Trigger_Volume_2), {__call = new})
P3D.TriggerVolume2P3DChunk.new = new
function P3D.TriggerVolume2P3DChunk:parse(Contents, Pos, DataLength)
...
function P3D.TriggerVolume2P3DChunk:__tostring()
	local chunks = {}
