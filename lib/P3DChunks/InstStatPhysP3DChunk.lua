...
P3D.InstStatPhysP3DChunk = setmetatable(P3D.P3DChunk:newChildClass(P3D.Identifiers.Inst_Stat_Phys), {__call = new})
...
function P3D.InstStatPhysP3DChunk:__tostring()
	local chunks = {}
